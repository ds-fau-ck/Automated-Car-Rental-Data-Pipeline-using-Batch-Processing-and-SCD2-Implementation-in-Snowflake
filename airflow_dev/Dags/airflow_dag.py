...
CLUSTER_NAME = 'cluster-de'
PROJECT_ID = 'just-keyword-426603-n0'
REGION = 'us-central1'

pyspark_job_file_path = 'gs://snowflake_project_fau/spark_job/spark_job.py'
...
submit_pyspark_job = DataprocSubmitPySparkJobOperator(
    ...
    dag=dag,
    dataproc_jars=['gs://snowflake_project_fau/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar', 'gs://snowflake_project_fau/snowflake_jars/snowflake-jdbc-3.16.0.jar']
)
