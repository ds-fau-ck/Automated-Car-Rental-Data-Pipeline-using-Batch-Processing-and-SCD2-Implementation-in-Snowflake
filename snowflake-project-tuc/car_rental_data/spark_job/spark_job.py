...
def process_car_rental_data(data_date):
    ...
    spark = SparkSession.builder \
        ...
        .config("spark.jars", "gs://snowflake_project_fau/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar,gs://snowflake_project_fau/snowflake_jars/snowflake-jdbc-3.16.0.jar") \
        .getOrCreate()

    # Define GCS file path based on the date argument
    gcs_file_path = f"gs://snowflake_project_fau/car_rental_data/car_rental_daily_data/car_rental_{data_date}.json"
    ...
    snowflake_options = {
        "sfURL": "https://qnsxhes-ue50103.snowflakecomputing.com",
        "sfAccount": "qnsxhes-ue50103",
        "sfUser": "chkul",
        "sfPassword": "aM=k9wD7",
